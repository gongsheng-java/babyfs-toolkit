...
/**
 * Base Dao  For {@link BaseStrListEntity}
 */
public interface IBaseStrListDao<T extends BaseStrListEntity> extends IDao<T> {
    /**
     * 使用offset机制查询数据,通过{@link BaseStrListEntity#getTargetId()}排序和分页
     *
     * @param ownerId
     * @param from
     * @param limit
    ...
    List<Object[]> getByPageByTargetId(@SqlParam("ownerId") String ownerId, @SqlParam("from") long from, @SqlParam("limit") long limit);

    /**
     * 根据next_cursor获取列表,通过{@link BaseStrListEntity#getTargetId()}排序和分页
     *
     * @param ownerId
     * @return
     */
    ...
    List<Object[]> getByNextCursorByTargetId(@SqlParam("ownerId") String ownerId, @SqlParam("limit") long limit, @SqlParam("cursorId") long cursorId);

    /**
     * 根据pre_cursor获取列表,通过{@link BaseStrListEntity#getTargetId()}排序和分页
     *
     * @param ownerId
     * @return
     */
    @Sql(type = SqlType.QUERY_COLUMNS, columns = "t_id,id", condition = "where o_id = :ownerId and t_id > :cursorId order by t_id limit :limit")
    List<Object[]> getByPreCursorByTargetId(@SqlParam("ownerId") String ownerId, @SqlParam("limit") long limit, @SqlParam("cursorId") long cursorId);

    /**
     * 使用offset机制查询数据,通过{@link BaseStrListEntity#getId()}}排序和分页
     *
     * @param ownerId
     * @param from
     * @param limit
    ...
    List<Object[]> getByPageById(@SqlParam("ownerId") String ownerId, @SqlParam("from") long from, @SqlParam("limit") long limit);

    /**
     * 根据next_cursor获取列表,通过{@link BaseStrListEntity#getId()}}排序和分页
     *
     * @param ownerId
     * @return
     */
    @Sql(type = SqlType.QUERY_COLUMNS, columns = "t_id,id", condition = "where o_id= :ownerId and id < :cursorId order by id desc limit :limit")
    List<Object[]> getByNextCursorById(@SqlParam("ownerId") String ownerId, @SqlParam("limit") long limit, @SqlParam("cursorId") long cursorId);

    /**
     * 根据pre_cursor获取列表,通过{@link BaseStrListEntity#getId()}}排序和分页
     *
     * @param ownerId
     * @return
     */
    @Sql(type = SqlType.QUERY_COLUMNS, columns = "t_id,id", condition = "where o_id = :ownerId and id > :cursorId order by id limit :limit")
    List<Object[]> getByPreCursorById(@SqlParam("ownerId") String ownerId, @SqlParam("limit") long limit, @SqlParam("cursorId") long cursorId);
    ...
    List<T> getByOwnerAndTargetId(@SqlParam("ownerId") String ownerId, @SqlParam("targetId") long targetId);
    ...
    int delete(@SqlParam("ownerId") String ownerId, @SqlParam("targetId") long targetId);
