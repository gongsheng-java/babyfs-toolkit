...
import com.babyfs.tk.service.biz.service.counter.intergration.guice.CounterServiceModule;
...
public class CounterServiceTest {
    ...
    public void testProcess() throws Exception {
        ...
        ICounterService service = injector.getInstance(ICounterService.class);
        Date date = new Date();
