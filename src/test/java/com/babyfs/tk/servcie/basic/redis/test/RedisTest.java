package com.babyfs.tk.servcie.basic.redis.test;
...
public class RedisTest {
    ...
    public void testGet() throws Exception {
        ...
        CommonNameResourceServiceImpl<IRedis> redisService = new CommonNameResourceServiceImpl<IRedis>(new ShardedRedisServiceLoaderImpl(new RedisConfig(), redisServers, serviceGroup));
    ...
    public void testJedisPool() throws Exception {
        Servers redisServers = JAXBUtil.unmarshal(Servers.class, "redis-servers.xml");
        ServiceGroup serviceGroup = JAXBUtil.unmarshal(ServiceGroup.class, "redis-client.xml");
        CommonNameResourceServiceImpl<JedisPool> redisService = new CommonNameResourceServiceImpl<JedisPool>(new JRedisPoolServiceLoaderImpl(new RedisConfig(), redisServers, serviceGroup));
